...
class crypto
{
    public:
        ...
        static void generateRandomUid(unsigned char* uid);
        ...
        static void get_digest(unsigned char* epoch, unsigned char* sealedData, unsigned char* publicKey, unsigned char* digest);
        ...
        static void signRoot(std::string root, unsigned char* randomSeed, const unsigned char* pmSecretKey, unsigned char* signature);
        static bool verifyRootSignature(std::string root, unsigned char* randomSeed, const unsigned char* pmPublicKey, unsigned char* signature);
}; 
#endif // CRYPTO_H
